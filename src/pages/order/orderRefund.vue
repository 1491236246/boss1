<template>
<div class="orderRefund global_div">
    <content-top titlename="退货申请"></content-top>
    <div class="center_div">
        <el-button :class="{bakc_el:status=='all'}" @click="status='all'">全部申请({{all}})</el-button>
        <el-button :class="{bakc_el:status==2}" @click="status=2">待处理(<span class="spa_red">{{dcl}}</span>)</el-button>
        <el-button :class="{bakc_el:status==4}" @click="status=4">已处理(<span class="spa_red">{{ycl}}</span>)</el-button>
        <el-button :class="{bakc_el:status==5}" @click="status=5">已拒绝(<span class="spa_red">{{yjj}}</span>)</el-button>

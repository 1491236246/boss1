<template>
  <div class="orderdetail global_div">
    <content-top titlename="订单详情"></content-top>
    <div class="center_div">
        ...
        <div class="order-info clearFix">
            ...
            <div class="fr">
                <el-button @click="dialogVisible = true; dialogStatus = 1; title = '修改收货人信息';">修改收货人信息</el-button>
                <el-button  v-if="datalist.status == 1" @click="close">关闭订单</el-button>
                <el-button  @click="dialogVisible = true; dialogStatus = 2; title = '备注订单';">备注订单</el-button>
                <el-button @click="$router.push({name:'orderList'})">返回</el-button>
            </div>
        </div>
      ...
      <el-table class="mall-table" :data="datalist.details" >
        <el-table-column label="商品图片">
          <template slot-scope="scope">
            <img :src="scope.row.goodsPic.split(',')[0]"/>
          </template>
        </el-table-column>
    ...
    getOrderInfo(){
      ...
      submitForm(formName) {
        if (this.dialogStatus == 1){
          ...
          this.$http.post("merchant_order/updateOrder", {
            id: this.ruleForm.id,

<template>
    <div class="Addadvert global_div">
        <div class="center_div">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="form">
                ...
                <div class="upload-btn-wrap">
                    ...
                    <input id="upload" type="file" class="upload-input" accept="image/jpeg, image/png" @change="uploadadPicture">
...
export default {
    ...
    data(){
      ...
      return{
        ...
        rules: {
          ...
          adPicture: [
            { validator: validPic, required: true, trigger: 'change' }
          ],
          adLink: [
    ...
    created() {
        if (this.$route.query.id){
            this.loading = true;
            this.$http.post('merchant_ad/get_single_merchant_ad',{

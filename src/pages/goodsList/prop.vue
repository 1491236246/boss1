    ...
    <div class="center_div">
        <div class="list_content">
            <div class="list_title">
                ...
                <el-button class="el_right" @click="$router.push({name:'addprop'})">添加属性</el-button>
            </div>
            <el-table
            ref="multipleTable"
            :data="tableData3"
        ...
        >
            ...
            <el-table-column label="属性是否可选">
                <template slot-scope="scope">
                    {{scope.row.propertySelect | capitalize}}
                </template>
            </el-table-column>

            <el-table-column label="可选值列表" prop="propertyList"></el-table-column>

            <el-table-column label="排序" prop="propertyOrder"></el-table-column>
...
export default {
  ...
  methods: {
    goAsed(id){
      this.$router.push({name:"addprop",query:{id:id}});
    },
    remove(id){
